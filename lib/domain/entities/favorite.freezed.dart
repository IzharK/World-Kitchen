...
abstract class $FavoriteCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String image, String area});
}
...
class _$FavoriteImpl implements _Favorite {
  ...
  @override
  String toString() {
    return 'Favorite(id: $id, name: $name, image: $image, area: $area)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, image, area);
